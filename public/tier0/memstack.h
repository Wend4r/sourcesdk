...
public:
	...
	DLL_CLASS_IMPORT bool Init( const char *pszAllocOwner, unsigned maxSize = 0, unsigned commitIncrement = 0, unsigned initialCommit = 0, unsigned alignment = 16 );
#ifdef _GAMECONSOLE
	...
	DLL_CLASS_IMPORT void Access( void **ppRegion, unsigned *pBytes );
