...
function(append_sourcesdk_shared_library VAR_NAME LIB_NAME LIB_FILENAME_OUT IMPLIB_FILENAME_OUT)
	...
	set(${LIB_FILENAME_OUT} "${SOURCESDK_APPEND_SHARED_LIBRARY_LIB}${SOURCESDK_SHARED_LIBRARY_LIB_NAME}${CMAKE_SHARED_LIBRARY_SUFFIX}" PARENT_SCOPE)
	set(${IMPLIB_FILENAME_OUT} "${SOURCESDK_APPEND_SHARED_LIBRARY_LIB}${SOURCESDK_SHARED_LIBRARY_LIB_NAME}${CMAKE_STATIC_LIBRARY_SUFFIX}" PARENT_SCOPE)
	...
	if(SOURCESDK_LINK_STRIP_CPP_EXPORTS AND LINUX)
		...
		if(NOT EXISTS ${SOURCESDK_BINARY_SHARED_LIBRARY_LIB})
			configure_file(${${LIB_FILENAME_OUT}} ${SOURCESDK_BINARY_SHARED_LIBRARY_LIB} COPYONLY)
