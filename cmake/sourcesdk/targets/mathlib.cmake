...
set(SOURCESDK_PUBLIC_MATHLIB_INCLUDE_DIR "${SOURCESDK_DIR}/public/mathlib")
...
add_library(${TARGET_NAME}::${SOURCESDK_MATHLIB_NAME} ALIAS ${SOURCESDK_MATHLIB_NAME})
...
target_compile_options(${SOURCESDK_MATHLIB_NAME} PRIVATE ${PLATFORM_COMPILE_OPTIONS} ${SOURCESDK_MATHLIB_COMPILER_OPTIONS})
target_link_options(${SOURCESDK_MATHLIB_NAME} PRIVATE ${PLATFORM_LINK_OPTIONS} ${SOURCESDK_MATHLIB_LINK_OPTIONS})

target_compile_definitions(${SOURCESDK_MATHLIB_NAME} PRIVATE ${PLATFORM_COMPILE_DEFINITIONS} ${SOURCESDK_MATHLIB_COMPILE_DEFINITIONS})
