if(NOT GAME_PROTOBUFS_DIR)
	message(FATAL_ERROR "GAME_PROTOBUFS_DIR is empty")
endif()

set(SOURCESDK_MANIFESTS_PROTO_ABSOLUTE_DIR "${GAME_PROTOBUFS_DIR}/${SOURCESDK_MANIFESTS_GAME_PROTO_DIR}")
