...
foreach(PROTO_FILENAME IN LISTS SOURCESDK_PROTO_FILENAME_FILES)
	...
	get_filename_component(PROTO "${PROTO_FILENAME}" NAME_WE)
	set(PROTO_SOURCE_BASE_FILENAME "${PROTO_DIR}/${PROTO}.pb.cc")
	set(PROTO_SOURCE_FILENAME "${SOURCESDK_DIR}/${PROTO_SOURCE_BASE_FILENAME}")

	if(NOT EXISTS ${PROTO_SOURCE_FILENAME})
