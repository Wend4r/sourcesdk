...
function(sourcesdk_compile_protos PROTO_FILENAMES PROTO_ARGS PROTO_DIR PROTO_OUTPUT_DIR LOGS_DIR ERROR_LOGS_DIR PROTO_OUT_PREFIX)
	if(PROTO_DIR)
	...
	foreach(PROTO_FILENAME IN LISTS PROTO_FILENAMES)
		...
		if(PROTO_DIRECTORY)
			set(PROTO_OUT_DIR "${PROTO_OUTPUT_DIR}/${PROTO_DIRECTORY}")
		else()
			set(PROTO_OUT_DIR ${PROTO_OUTPUT_DIR})
		endif()
		...
		if(EXISTS "${PROTO_OUT_SOURCE}")
			...
			set(PROTO_OUTPUT_LOG_DIR "${LOGS_DIR}/${PROTO_DIRECTORY}")
			set(PROTO_ERROR_DIR "${ERROR_LOGS_DIR}/${PROTO_DIRECTORY}")

			if(NOT EXISTS PROTO_OUTPUT_LOG_DIR)
				file(MAKE_DIRECTORY ${PROTO_OUTPUT_LOG_DIR})
			endif()
			if(NOT EXISTS PROTO_ERROR_DIR)
				file(MAKE_DIRECTORY ${PROTO_ERROR_DIR})
			endif()
			...
			execute_process(
				...
				COMMAND ${SOURCESDK_PROTOC_EXECUTABLE} ${PROTO_ARGS} --cpp_out=${PROTO_OUTPUT_DIR} ${PROTO_FILENAME}
