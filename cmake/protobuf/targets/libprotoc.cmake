...
target_compile_options(${PROTOBUF_LIBPROTOC_NAME} PRIVATE ${PLATFORM_COMPILE_OPTIONS})
target_link_options(${PROTOBUF_LIBPROTOC_NAME} PRIVATE ${PLATFORM_LINK_OPTIONS})

target_compile_definitions(${PROTOBUF_LIBPROTOC_NAME} PRIVATE ${PLATFORM_COMPILE_DEFINITIONS})
target_include_directories(${PROTOBUF_LIBPROTOC_NAME} PRIVATE ${PLATFORM_INCLUDE_DIRS})
